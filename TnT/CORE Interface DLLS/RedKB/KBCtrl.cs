...
namespace PTPLKB
{
    public partial class KBCtrl : UserControl
    {
        public KBCtrl()
        {
            InitializeComponent();
        ...
        public BoW KeyboardType
        {
            ...
            set
            {
                ...
                if (capslockindicator) HandleCapsLock(true);

                if (pvtKeyboardType == BoW.Standard)
                {
                    pictureBoxKeyboard.Image = PTPLKB.Properties.Resources.keyboard_white;
                    pictureBoxCapsLockDown.Image = PTPLKB.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = PTPLKB.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = PTPLKB.Properties.Resources.shift_down_white;
                }
                else if (pvtKeyboardType==BoW.Alphabetical)
                {
                    pictureBoxKeyboard.Image = PTPLKB.Properties.Resources.keyboard_alphabetical;
                    pictureBoxCapsLockDown.Image = PTPLKB.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = PTPLKB.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = PTPLKB.Properties.Resources.shift_down_white;
                }
                else if (pvtKeyboardType == BoW.Short)
                {
                    pictureBoxKeyboard.Image = PTPLKB.Properties.Resources.keyboard_shortSmall;
                    pictureBoxCapsLockDown.Image = PTPLKB.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = PTPLKB.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = PTPLKB.Properties.Resources.shift_down_white;
                }
                ...
                {
                    pictureBoxKeyboard.Image = PTPLKB.Properties.Resources.keyboard_kids_lower;
                }
            }
        }
        public bool CapsLock(bool state)
        {
            if (capslockindicator != state)
        ...
        private void pictureBoxKeyboard_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                xpos = KBWidth * (xpos / pictureBoxKeyboard.Width);
                ypos = KBHeight * (ypos / pictureBoxKeyboard.Height);
            ...
            else if (pvtKeyboardType == BoW.Short)
            {
                ...
                pvtKeyboardKeyPressed = HandleShortKBMouseClick(xpos, ypos);
            }
            else
            {
                xpos = KBWidth * (xpos / pictureBoxKeyboard.Width);
        ...
        private string HandleKidsMouseClick(Single x, Single y)
        {
            ...
            else if (y >= 73 && y < 141)
            {
                ...
                else if (x >= 491 && x < 672) HandleCapsLock(true);
                else if (x >= 672 && x < 764) Keypressed = ",";
        ...
        private string HandleTheMouseClick(Single x, Single y)
        {
            ...
            if (x >= 4 && x < 815 && y >= 3 && y < 277)         //  keyboard section
            {
                ...
                {
                    if (x >= 4 && x < 113) HandleCapsLock(true);
        ...
        private string HandleShortKBMouseClick(Single x, Single y)
        {
            string Keypressed = null;
            if (x >= 4 && x < 815 && y >= 3 && y < 277)         //  keyboard section
            {
        ...
        {
            if (pvtKeyboardType != BoW.Standard && pvtKeyboardType != BoW.Short)
            {
                switch (theKey)
                {
                    case ("q"):
            ...
            if (capslockindicator == true && shiftindicator == false && Control.IsKeyLocked(Keys.CapsLock) == false) //If Both KB CAPS is on, no need to set,
            {
                return "+" + theKey;
            }
            else if (shiftindicator == true && capslockindicator == false)
            {
                return "+" + theKey;
            }
            else
        ...
        private void HandleCapsLock(bool send2HWKB)
        {
            ...
            else
            {
                ...
                if (pvtKeyboardType == BoW.Kids)
                    pictureBoxKeyboard.Image = PTPLKB.Properties.Resources.keyboard_kids_upper;
                else if (pvtKeyboardType == BoW.Short)
                {
                    pictureBoxKeyboard.Image = PTPLKB.Properties.Resources.keyboard_short;
            ...
            if (send2HWKB == true)
            {
                pvtKeyboardKeyPressed = "{CAPSLOCK}";
                KeyboardEventArgs dea = new KeyboardEventArgs(pvtKeyboardKeyPressed);
        ...
        private void pictureBoxKeyboard_SizeChanged(object sender, EventArgs e)
        {
            ...
            pictureBoxCapsLockDown.Left = Convert.ToInt16(pictureBoxKeyboard.Width * 5 / KBWidth);
            pictureBoxCapsLockDown.Top = Convert.ToInt16(pictureBoxKeyboard.Height * 115 / KBHeight);
            pictureBoxCapsLockDown.Width = Convert.ToInt16(pictureBoxKeyboard.Width * 110 / KBWidth);
            pictureBoxCapsLockDown.Height = Convert.ToInt16(pictureBoxKeyboard.Height * 55 / KBHeight);

            pictureBoxLeftShiftDown.Left = Convert.ToInt16(pictureBoxKeyboard.Width * 5 / KBWidth);
            pictureBoxLeftShiftDown.Top = Convert.ToInt16(pictureBoxKeyboard.Height * 169 / KBHeight);
            pictureBoxLeftShiftDown.Width = Convert.ToInt16(pictureBoxKeyboard.Width * 136 / KBWidth);
            pictureBoxLeftShiftDown.Height = Convert.ToInt16(pictureBoxKeyboard.Height * 55 / KBHeight);

            pictureBoxRightShiftDown.Left = Convert.ToInt16(pictureBoxKeyboard.Width * 681 / KBWidth);
            pictureBoxRightShiftDown.Top = pictureBoxLeftShiftDown.Top;
            pictureBoxRightShiftDown.Width = Convert.ToInt16(pictureBoxKeyboard.Width * 135 / KBWidth);
    ...
    public enum BoW { Standard, Alphabetical, Kids,Short };
}
