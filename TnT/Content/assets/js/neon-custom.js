...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		{
		    $(".multi-select").multiSelect({ selectableHeader: "<p style='text-align:center; font-weight:bold; padding: 9px;'>Select Batch</p>", selectionHeader: "<p style='text-align:center; font-weight:bold; padding: 9px;'>Transfer to Line</p>" });
		}
