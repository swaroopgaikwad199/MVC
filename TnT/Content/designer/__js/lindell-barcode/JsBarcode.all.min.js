...
(function(c) {
    JsBarcode = function(c, m, a, l) {
        ...
        window.jQuery && c instanceof jQuery ? c.get(0) instanceof HTMLCanvasElement || c.attr("src", uri) : c instanceof HTMLCanvasElement || c.setAttribute("src", uri);
        l && l(!0)
    };
    JsBarcode.defaults = {
        width: 2,
    ...
    window.jQuery && (c.fn.JsBarcode = function(c, m, a) {
