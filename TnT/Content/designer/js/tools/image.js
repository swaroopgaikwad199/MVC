...
com.logicpartners.designerTools.image = function () {
    var self = this;
    var stored_fields = ['x', 'y', 'type', 'name', 'data', 'rotated', 'timestamp', 'width', 'height', 'hh', 'ww'];
    ...
    this.activate = function (toolbar) {
        ...
        var imageFile = $("<input type=\"file\" accept=\"image/*\"/>").css({ width: 400 })
            .on("change", function () {
                ...
                if (!input.files[0]) {
                    ...
                    reader.onloadend = function () {
                        ...
                        insertImg[0].onload = function () {
                            ...
                            // Convert the canvas data to GRF. // FOR POTRATE IMAGE CONVERTION
                            ...
                            //Convert the canvas data to GRF. // FOR LANDSCAPE IMAGE CONVERTION
    ...
    this.object = function (x, y, width, height, data, rotated, timestamp) {
        ...
        this.readonly = ["width", "height", "data", "hh", "ww"];
        ...
        this.getZPLData = function () {
            ...
            var dpiVal = 8;
            //if (selDPI == "305") { dpiVal = 12; }

            if (PageOrientation == 'landscape') {

                var bytesPerLine = Math.ceil(this.height / dpiVal);
                ...
                return "~DGIMG" + parseInt(str2) + "," + bytesPerLine * width + "," + bytesPerLine + "," + imgData;
            } else {

                var bytesPerLine = Math.ceil(this.width / dpiVal);
                //console.log(bytesPerLine);
                //console.log(this.width);
                //console.log(bytesPerLine);
                ...
                return "~DGIMG" + parseInt(str2) + "," + bytesPerLine * height + "," + bytesPerLine + "," + imgData;
            }
        },
            ...
            this.toZPL = function (labelx, labely, labelwidth, labelheight) {
                ...
                if (selDPI == "203") { this.hh = 2; this.ww = 2; } else { this.hh = 3; this.ww = 3; }
                if (this.hh < 0 || this.hh == undefined || this.hh == "") { this.hh = 0; }
                if (this.ww < 0 || this.ww == undefined || this.ww == "") { this.ww = 0; }

                debugger;
                if (PaperOrientation == "portrait") {
                    return "^FO" + (this.x - labelx) * actualDPI + "," + (this.y - labely) * actualDPI + "^XGR:IMG" + parseInt(str2) + "," + this.hh + "," + this.ww + "^FS";
                    //return "^FO" + (this.x * actualDPI) + "," + (this.y * actualDPI) + "^XGR:IMG" + parseInt(str2) + "," + this.hh + "," + this.ww + "^FS";
                    ...
                    return "^FO" + ((paperWidth - (this.y - labely) * actualDPI) - height) + "," + (this.x - labelx) * actualDPI + "^XGR:IMG" + parseInt(str2) + "," + this.hh + "," + this.ww + "^FS";
                    //return "^FO" + (this.x * actualDPI) + "," + (this.y * actualDPI) + "^XGR:IMG" + parseInt(str2) + "," + this.hh + "," + this.ww + "^FS";
                }
            },
    ...
    com.logicpartners.designerTools.image.load = function (store) {
        var text, chars;
        debugger
        text = new self.object(store.x, store.y, store.width, store.height, store.hh, store.ww);
        for (var i = 0; i < stored_fields.length; i++)
            if (['data', 'rotated'].indexOf(stored_fields[i]) != -1) {
