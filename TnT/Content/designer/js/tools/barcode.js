    ...
    this.object = function (x, y, width, height) {
        ...
        this.toZPL = function (labelx, labely, labelwidth, labelheight) {
            ...
            if (PaperOrientation == "portrait") {
                ...
                return "^FO" + (this.x - labelx) * actualDPI + "," + (this.y - labely) * actualDPI + "^BY" + this.mil + "^BCN," + this.height * actualDPI + ",N,N,N^FD{{" + this.barcodeType.toUpperCase() + " || " + this.data + "}}^FS";
                ...
                return "^FO" + ((paperWidth - (this.y - labely) * actualDPI) - this.height * actualDPI) + "," + (this.x - labelx) * actualDPI + "^BY" + this.mil + "^BCR," + this.height * actualDPI + ",N,N,N^FD{{" + this.barcodeType.toUpperCase() + " || " + this.data + "}}^FS";
            }
        ...
        this.toZPLPrint = function (labelx, labely, labelwidth, labelheight) {
            ...
            if (PaperOrientation == "portrait") {
                ...
                return "^FO" + (this.x - labelx) * actualDPI + "," + (this.y - labely) * actualDPI + "^BY" + this.mil + "^BCN," + this.height * actualDPI + ",N,N,N^FD" + this.text + "^FS";

            } else if (PaperOrientation == 'landscape') {
                paperWidth = parseInt($(".clsHeight").val()) * parseInt(selDPI);
                paperHeight = parseInt($(".clsWidth").val()) * parseInt(selDPI);

                return "^FO" + ((paperWidth - (this.y - labely) * actualDPI) - this.height * actualDPI) + "," + (this.x - labelx) * actualDPI + "^BY" + this.mil + "^BCR," + this.height * actualDPI + ",N,N,N^FD" + this.text + " ^FS";
            }
        ...
        this.draw = function (context) {
            ...
            //canvasHolder.JsBarcode("#barcode", "Hi!");
